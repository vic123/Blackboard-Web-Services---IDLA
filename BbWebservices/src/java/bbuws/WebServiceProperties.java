...
public class WebServiceProperties
{
	...
	try
	{
	    ...
	    //System.err.println("gettingparam"+vendorId+"-"+applicationHandle+"-"+param);
	    sre = srdbl.loadByKey(vendorId+"-"+applicationHandle+"-"+param);
	    //System.err.println("param"+sre.getDescription()+sre.getValue());
	}
	...
	//System.err.println("methodaccess"+isMethodAccessible+method);
	...
	//System.err.println("usingp"+usingPwd);
	...
	//System.err.println("pmatch"+configPwd+pwd);
