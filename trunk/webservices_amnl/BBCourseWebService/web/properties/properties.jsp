...
%>
    <a href="/webapps/amnl-BBCourseWebService-bb_bb60/BBCourseWebService">Click for endpoint</a><br/>
    <a href="/webapps/amnl-BBCourseWebService-bb_bb60/BBCourseWebService?wsdl">Click for wsdl</a>
    </bbUI:docTemplate>
</bbData:context>