...
%>
    <a href="/webapps/amnl-BBGroupWebService-bb_bb60/BBGroupWebService">Click for endpoint</a><br/>
    <a href="/webapps/amnl-BBGroupWebService-bb_bb60/BBGroupWebService?wsdl">Click for wsdl</a>
    </bbUI:docTemplate>
</bbData:context>