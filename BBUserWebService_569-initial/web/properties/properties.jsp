...
<bbData:context>
	...
	<bbUI:titleBar>User webservice security properties</bbUI:titleBar>
...
%>
    <a href="/webapps/amnl-BBUserWebService-bb_bb60/BBUserWebService">Click for endpoint</a><br/>
    <a href="/webapps/amnl-BBUserWebService-bb_bb60/BBUserWebService?wsdl">Click for wsdl</a>
    </bbUI:docTemplate>
</bbData:context>